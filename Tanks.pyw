...
STARS_SIZE = 16
STARS_MAX = 100
ISP1, ISP2 = (10, 2), (WIDTH_WIN - 110, 2)
ISC = pg.Color('white')
HEIGHT_Earth = 250
speed = 8
...
while run[0]:
    ...
    screen.blit(font_menu2.render(f"Points: {count['killed']}", True, ISC), ISP1)
    screen.blit(font_menu2.render(f"Life: {int(count['life'])}", True, ISC), ISP2)
